...
export const ListagemDeRegistroEquivalencia: React.FC = () => {
  ...
  return (
    <LayoutBaseDePagina
      titulo='Listagem de Registro de Equivalencias'
      barraDeFerramentas={
        ...
        <Table>
          <TableHead>
            <TableRow>
              ...
              <TableCell>Professor Analisador</TableCell>
            ...
            {rows.map(row => (
              <TableRow key={row.id}>
                <TableCell>
                  ...
                  <IconButton size="small" onClick={() => navigate(`/registro_equivalencia/detalhe/${row.id}`)}>
                    <Icon>edit</Icon>
                  </IconButton>
                </TableCell>
                <TableCell>{row.cursoOrigem}</TableCell>
                <TableCell>{row.cursoDestino}</TableCell>
                <TableCell>{row.professorAnalisador}</TableCell>
